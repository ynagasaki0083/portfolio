...
const Nav = ({ openNav }: Props) => {
  ...
  return (
    <div
      className={`fixed ${
        navBg ? "bg-[#479aff]" : "fixed"
      } h-[12vh] z-[10] bg-[#0070f7] w-full transition-all duration-200`}
    >
      <div className="flex items-center h-full justify-between w-[9S%] sm:w-[95%] xl:w-[95%] mx-auto">
        {/* LOGO */}
        <Image
          src="/logo.png"
          alt="LOGO"
